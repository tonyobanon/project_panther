...
public class QueryResult {
	...
	public QueryResult setItems(List<Item> items) {
		this.items = items;
		return this;
	}
	...
	public QueryResult setCount(Integer count) {
		this.count = count;
		return this;
	}
	...
	public QueryResult setScannedCount(Integer scannedCount) {
	...
	public QueryResult setLastEvaluatedKey(PrimaryKey lastEvaluatedKey) {
