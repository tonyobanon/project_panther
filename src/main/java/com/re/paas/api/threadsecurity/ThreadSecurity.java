...
public abstract class ThreadSecurity {
	...
	public static void verify() {
		if (!ThreadSecurity.hasTrust()) {
			Exceptions.throwRuntime(new SecurityException("Unable to verify thread security"));
		}
	}
	...
	public abstract ThreadSecurity init(Thread t);
	...
	public abstract void runTrusted(Runnable r);
	 ...
	 * @return
	 */
	public abstract void runCommon(Runnable r, AppClassLoader cl);
