...
public class BufferImpl extends Buffer {
	...
	private void ensureWritable(int pos, int len) {
		...
		// We have to make sure that the writerindex is always positioned on the last
		// bit of data set in the buffer
