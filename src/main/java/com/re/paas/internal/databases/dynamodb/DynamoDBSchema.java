...
public class DynamoDBSchema extends AbstractSchema {
    ...
    public static final String META_TABLE_NAME_ATTRIBUTE = "TABLE_NAME";
    ...
    protected Map<String, Table> getTableMap() {
        ...
        while (dynamoDBTableSchemas.hasNext()) {
            ...
            String tableName = dynamoDBTableSchema.get(META_TABLE_NAME_ATTRIBUTE).getS();
            ...
            if (tableDescription.getTableStatus().equals("ACTIVE")) {
                dynamoDBTableSchema.remove(META_TABLE_NAME_ATTRIBUTE);
