...
public class AppDelegate {
	...
	private static void addPlatformObjects() {
		...
		// This is eagerly assigned because Singleton uses it
		...
		Factory.register(AppClassLoader.class, p -> new AppClassLoaderImpl(AppDelegate.class.getClassLoader(),
	...
	public static void main() {
		...
		ThreadSecurity.get().init(Thread.currentThread()).trust();
