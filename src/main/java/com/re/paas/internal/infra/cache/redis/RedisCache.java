...
public class RedisCache implements Cache<String, Object> {
	...
	private RedisClient createRedisClient() {
		...
		RedisConfig config = factory.getConfig();
	...
	public CompletableFuture<PartitionedSet<String>> sgetOrDefault(PersistenceType persistenceType, String key,
		...
		Callable<CompletionStage<Object>> work = () -> {
			...
			// Get key length
			String len = (String) this.hget(key, keyLength).join();
	...
	public CompletableFuture<Boolean> sdel(String key, String value) {
		...
		Callable<CompletionStage<Boolean>> work = () -> {
			...
			String k = (String) this.hget(valueKeyMappingPrefix + key, value).join();
	...
	@Override
	public CompletableFuture<Boolean> mset(PersistenceType persistenceType, String key, Map<String, Object> value) {
	...
	public CompletableFuture<Object> get(String key) {
		...
		CompletableFuture<Object> o = (CompletableFuture<Object>) this.commands.get(key);
		this.decrStack();
		return o;
	}
	...
	public CompletableFuture<Object> hget(String key, String field) {
		this.incrStack();
		@SuppressWarnings("unchecked")
		CompletableFuture<Object> o = (CompletableFuture<Object>) this.commands.hget(key, field);
		this.decrStack();
		return o;
	}
	...
	public CompletableFuture<Map<String, Object>> hgetall(String key) {
		this.incrStack();
		@SuppressWarnings("unchecked")
		CompletableFuture<Map<String, Object>> o = (CompletableFuture<Map<String, Object>>) this.commands.hgetall(key);
		this.decrStack();
		return o;
	}
