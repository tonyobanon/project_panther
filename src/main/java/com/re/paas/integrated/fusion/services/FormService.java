...
import com.re.paas.integrated.fusion.functionalities.FormFunctionalities;
...
public class FormService extends BaseService {
	...
	public static void listApplicationFormFields(RoutingContext ctx) {
		...
		Map<String, AbstractField> fields = FormModel.getFields(FormSectionType.APPLICATION_FORM, sectionId);
	...
	public static void listApplicationFormFieldNames(RoutingContext ctx) {
		...
		Map<String, ClientRBRef> fields = FormModel.getFieldTitle(FormSectionType.APPLICATION_FORM, sectionId);
		ctx.response().write(Json.getGson().toJson(fields)).end();
	}
	...
	public static void listAllApplicationFormFields(RoutingContext ctx) {
		...
		Map<String, Map<String, AbstractField>> fields = FormModel.getAllFields(FormSectionType.APPLICATION_FORM, sectionIds);
		ctx.response().write(Json.getGson().toJson(fields)).end();
	}
	...
	public static void listSystemConfigurationFields(RoutingContext ctx) {
		...
		Map<String, AbstractField> fields = FormModel.getFields(FormSectionType.SYSTEM_CONFIGURATION, sectionId);
		ctx.response().write(Json.getGson().toJson(fields)).end();
	}
	...
	public static void listSystemConfigurationFieldNames(RoutingContext ctx) {
		...
		Map<String, ClientRBRef> fields = FormModel.getFieldTitle(FormSectionType.SYSTEM_CONFIGURATION, sectionId);
		ctx.response().write(Json.getGson().toJson(fields)).end();
	}
	...
	public static void listAllSystemConfigurationFields(RoutingContext ctx) {
		...
		Map<String, Map<String, AbstractField>> fields = FormModel.getAllFields(FormSectionType.SYSTEM_CONFIGURATION, sectionIds);
		ctx.response().write(Json.getGson().toJson(fields)).end();
	}
