...
public class AttributeValue {
	...
	/**
	 * Default constructor for AttributeValue object. Callers should use the setter
	 * or fluent setter (with...) methods to initialize the object after creating
	 * it.
	 */
	 ...
	 * fluent setter (with...) methods to initialize any additional object members.
	 * 
	 ...
	 * </p>
	 * <p>
	 * The AWS SDK for Java performs a Base64 encoding on this field before sending
	 * this request to the AWS service. Users of the SDK should not perform Base64
	 * encoding on this field.
	 * </p>
	 * <p>
	 * Warning: ByteBuffers returned by the SDK are mutable. Changes to the content
	 * or position of the byte buffer will be seen by all objects that have a
	 * reference to this object. It is recommended to call ByteBuffer.duplicate() or
	 * ByteBuffer.asReadOnlyBuffer() before using or reading from the buffer. This
	 ...
	 * </p>
	 * <p>
	 * {@code ByteBuffer}s are stateful. Calling their {@code get} methods changes
	 * their {@code position}. We recommend using
	 * {@link java.nio.ByteBuffer#asReadOnlyBuffer()} to create a read-only view of
	 * the buffer with an independent {@code position}, and calling {@code get}
	 * methods on this rather than directly on the returned {@code ByteBuffer}.
	 * Doing so will ensure that anyone else using the {@code ByteBuffer} will not
	 * be affected by changes to the {@code position}.
	 * </p>
	 * 
	 ...
	 * Use {@link #setSS(java.util.Collection)} or
	 * {@link #withSS(java.util.Collection)} if you want to override the existing
	 * values.
	 * </p>
	 * 
	 * @param sS An attribute of type String Set. For example:
	 ...
	 * <p>
	 * <b>NOTE:</b> This method appends the values to the existing list (if any).
	 * Use {@link #setNS(java.util.Collection)} or
	 * {@link #withNS(java.util.Collection)} if you want to override the existing
	 * values.
	 * </p>
	 * 
	 * @param nS An attribute of type Number Set. For example:
	 ...
	 * <p>
	 * <b>NOTE:</b> This method appends the values to the existing list (if any).
	 * Use {@link #setBS(java.util.Collection)} or
	 * {@link #withBS(java.util.Collection)} if you want to override the existing
	 * values.
	 * </p>
	 * 
	 * @param bS An attribute of type Binary Set. For example:
	 ...
	 * <p>
	 * <b>NOTE:</b> This method appends the values to the existing list (if any).
	 * Use {@link #setL(java.util.Collection)} or
